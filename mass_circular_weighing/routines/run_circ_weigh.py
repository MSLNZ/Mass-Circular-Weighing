...
#         date_start, t_start, rh_start = LabView_dll.get_t_rh_now(str(ambient_details['Alias']), sensor=ambient_details['Sensor'])
...
#
#         LabView_dll = LabEnviron64()
#         t_data, rh_data = LabView_dll.get_t_rh_during(str(ambient_details['Alias']), sensor=ambient_details['Sensor'], start=ambient_pre['Start time'])
