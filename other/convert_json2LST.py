...
json_file = r'I:\MSL\Private\Mass\Commercial Calibrations\2023\AX1006PostService\backups\MassStds_1000-28-11-23.json'
...
for grp in jsonroot['Circular Weighings'].groups():
    ...
    wb.save(os.path.join(folder, last_date + "_" + se + "_LST.xlsx"))
