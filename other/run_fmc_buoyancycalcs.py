...
collated_data = collate_all_weighings(schemetable, cfg)[3:]  # first run was re-done
...
fmc.UNC_AIR_DENS = False  # here this is negligible compared to the weighing uncertainty
fmc.UNC_VOL = False
